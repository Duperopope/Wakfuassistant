...
| Script | Rôle |
|--------|------|
| `rnd/poc-hdv/agent/launch_hdv_v2.bat` | Capture des payloads |
| `rnd/poc-hdv/sync_hdv_to_sqlite.ps1` | Sync proto → SQLite |
| `rnd/poc-hdv/export_hdv_readable.ps1` | Export lisible |
| `rnd/poc-hdv/GUIDE_REPRO_HDV_NON_CODEUR.md` | Guide non-codeur |
