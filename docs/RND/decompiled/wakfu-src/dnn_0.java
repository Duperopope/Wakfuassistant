...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        String string = "pmbDefaultButtonPrimarySmall";
        ...
        fze2.setTexture(this.okR.uF("txPrimaryButtonSmall"));
        fze2.setWidth(36);
        fze2.setX(0);
        fze2.setY(0);
        fkd_12.X(fze2);
        ...
        String string2 = "pmbHoverButtonPrimarySmall";
        ...
        String string3 = "pmbPressedButtonPrimarySmall";
        ...
        fze4.setTexture(this.okR.uF("txPrimaryButtonSmall"));
        fze4.setWidth(36);
        fze4.setX(0);
        fze4.setY(76);
        fkd_14.X(fze4);
        ...
        String string4 = "pmbDisabledButtonPrimarySmall";
