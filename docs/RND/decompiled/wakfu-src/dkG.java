...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        String string = "pmKamasPrimaryMedium";
        ...
        String string2 = "pmKamasPrimaryLight";
        ...
        fze3.setTexture(this.okR.uF("txKamas"));
        fze3.setWidth(16);
        fze3.setX(2);
        fze3.setY(24);
        fym_03.X(fze3);
        ...
        String string3 = "pmKamasWhite100";
        ...
        fze5.setTexture(this.okR.uF("txKamas"));
        fze5.setWidth(16);
        fze5.setX(2);
        fze5.setY(90);
        fym_05.X(fze5);
