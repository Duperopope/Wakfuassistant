...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fym_02);
        fym_02.guy();
        String string = "pmbDefaultButtonNegativeXS";
        ...
        fze2.setTexture(this.okR.uF("txNegativeXSButton"));
        fze2.setWidth(28);
        fze2.setX(0);
        fze2.setY(0);
        fkd_12.X(fze2);
        ...
        fze3.setTexture(this.okR.uF("txFlag"));
        fze3.setWidth(16);
        fze3.setX(2);
        fze3.setY(46);
        fym_02.X(fze3);
        ...
        fes_22.X(fym_03);
        fym_03.guy();
        String string3 = "pmbHoverButtonNegativeXS";
        ...
        fze4.setTexture(this.okR.uF("txNegativeXSButton"));
        fze4.setWidth(28);
        fze4.setX(0);
        fze4.setY(30);
        fkd_13.X(fze4);
        ...
        fze5.setTexture(this.okR.uF("txFlag"));
        fze5.setWidth(16);
        fze5.setX(2);
        fze5.setY(46);
        fym_03.X(fze5);
        ...
        fes_22.X(fym_04);
        fym_04.guy();
        String string5 = "pmbPressedButtonNegativeXS";
        ...
        fze6.setTexture(this.okR.uF("txNegativeXSButton"));
        fze6.setWidth(28);
        fze6.setX(0);
        fze6.setY(60);
        fkd_14.X(fze6);
        ...
        fze7.setTexture(this.okR.uF("txFlag"));
        fze7.setWidth(16);
        fze7.setX(2);
        fze7.setY(46);
        fym_04.X(fze7);
        ...
        fes_22.X(fym_05);
        fym_05.guy();
        String string7 = "pmbDisabledButtonNegativeXS";
        ...
        fze8.setTexture(this.okR.uF("txNegativeXSButton"));
        fze8.setWidth(28);
        fze8.setX(0);
        fze8.setY(90);
        fkd_15.X(fze8);
        ...
        fze9.setTexture(this.okR.uF("txFlag"));
        fze9.setWidth(16);
        fze9.setX(2);
        fze9.setY(90);
        fym_05.X(fze9);
