...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fym_02);
        fym_02.guy();
        String string = "pmExchangeMachineButtonDefault";
        ...
        fze2.setTexture(this.okR.uF("txExchangeMachineButton"));
        fze2.setWidth(62);
        fze2.setX(0);
        fze2.setY(0);
        fym_02.X(fze2);
        ...
        fes_22.X(fym_03);
        fym_03.guy();
        String string2 = "pmExchangeMachineButtonHover";
        ...
        fze3.setTexture(this.okR.uF("txExchangeMachineButton"));
        fze3.setWidth(62);
        fze3.setX(0);
        fze3.setY(64);
        fym_03.X(fze3);
        ...
        fes_22.X(fym_04);
        fym_04.guy();
        String string3 = "pmExchangeMachineButtonPressed";
        ...
        fze4.setTexture(this.okR.uF("txExchangeMachineButton"));
        fze4.setWidth(62);
        fze4.setX(0);
        fze4.setY(128);
        fym_04.X(fze4);
        ...
        fes_22.X(fym_05);
        fym_05.guy();
        String string4 = "pmExchangeMachineButtonDisabled";
        ...
        fze5.setTexture(this.okR.uF("txExchangeMachineButton"));
        fze5.setWidth(62);
        fze5.setX(0);
        fze5.setY(192);
        fym_05.X(fze5);
