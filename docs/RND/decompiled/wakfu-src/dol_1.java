...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fym_02);
        fym_02.guy();
        String string = "pmbDefaultButtonReduceHudMenu";
        ...
        fze2.setTexture(this.okR.uF("txReduceHudButton"));
        fze2.setWidth(15);
        fze2.setX(0);
        fze2.setY(0);
        fkd_12.X(fze2);
        ...
        fes_22.X(fym_03);
        fym_03.guy();
        String string2 = "pmbHoverButtonReduceHudMenu";
        ...
        fze3.setTexture(this.okR.uF("txReduceHudButton"));
        fze3.setWidth(15);
        fze3.setX(0);
        fze3.setY(24);
        fkd_13.X(fze3);
        ...
        fes_22.X(fym_04);
        fym_04.guy();
        String string3 = "pmbPressedButtonReduceHudMenu";
        ...
        fze4.setTexture(this.okR.uF("txReduceHudButton"));
        fze4.setWidth(15);
        fze4.setX(0);
        fze4.setY(48);
        fkd_14.X(fze4);
        ...
        fes_22.X(fym_05);
        fym_05.guy();
        String string4 = "pmbDisabledButtonReduceHudMenu";
        ...
        fze5.setTexture(this.okR.uF("txReduceHudButton"));
        fze5.setWidth(15);
        fze5.setX(0);
        fze5.setY(0);
        fkd_15.X(fze5);
