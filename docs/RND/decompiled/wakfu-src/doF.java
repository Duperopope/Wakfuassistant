...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fym_03);
        fym_03.guy();
        String string2 = "pmbHoverButtonSecondaryXS";
        ...
        fze3.setTexture(this.okR.uF("txSecondaryXSButton"));
        fze3.setWidth(28);
        fze3.setX(0);
        fze3.setY(30);
        fkd_13.X(fze3);
        ...
        fes_22.X(fym_04);
        fym_04.guy();
        String string3 = "pmbPressedButtonSecondaryXS";
        ...
        fes_22.X(fym_05);
        fym_05.guy();
        String string4 = "pmbDisabledButtonSecondaryXS";
        ...
        fze5.setTexture(this.okR.uF("txSecondaryXSButton"));
        fze5.setWidth(28);
        fze5.setX(0);
        fze5.setY(90);
        fkd_15.X(fze5);
