...
implements fhk_1 {
    ...
    public fhi_2 a(fhu_1 fhu_12, fhs_2 fhs_22) {
        ...
        String string = "test";
        fem_1 fem_12 = new fem_1();
        fem_12.aVI();
        fem_12.setElementMap(fhs_23);
        if (fhs_23 != null && string != null) {
            fhs_23.a(string, fem_12);
        }
        fem_12.setPack(true);
        fem_12.guy();
        ...
        faw_22.setPrefSize(new fsm_1(0, 80));
