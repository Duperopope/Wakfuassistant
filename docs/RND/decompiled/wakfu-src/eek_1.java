...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fym_02);
        fym_02.guy();
        String string = "pmSmallUpSideArrow2Default";
        ...
        fes_22.X(fym_03);
        fym_03.guy();
        String string2 = "pmSmallUpSideArrow2Over";
        ...
        fes_22.X(fym_04);
        fym_04.guy();
        String string3 = "pmSmallUpSideArrow2Pressed";
        ...
        fes_22.X(fym_05);
        fym_05.guy();
        String string4 = "pmSmallUpSideArrow2Disabled";
        ...
        fes_22.X(fym_06);
        fym_06.guy();
        String string5 = "pmSmallUpSideArrow2DefaultSelected";
        ...
        fes_22.X(fym_07);
        fym_07.guy();
        String string6 = "pmSmallUpSideArrow2OverSelected";
        ...
        fes_22.X(fym_08);
        fym_08.guy();
        String string7 = "pmSmallUpSideArrow2PressedSelected";
        ...
        fes_22.X(fym_09);
        fym_09.guy();
        String string8 = "pmSmallUpSideArrow2DisabledSelected";
