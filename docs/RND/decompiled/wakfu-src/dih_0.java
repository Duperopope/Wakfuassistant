...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        String string = "pmChestPrimaryMedium";
        ...
        fze2.setTexture(this.okR.uF("txChest"));
        fze2.setWidth(16);
        fze2.setX(4);
        fze2.setY(4);
        fym_02.X(fze2);
        ...
        String string2 = "pmChestPrimaryLight";
        ...
        fze3.setTexture(this.okR.uF("txChest"));
        fze3.setWidth(16);
        fze3.setX(4);
        fze3.setY(30);
        fym_03.X(fze3);
        ...
        String string3 = "pmChestWhite100";
        ...
        fze4.setTexture(this.okR.uF("txChest"));
        fze4.setWidth(16);
        fze4.setX(4);
        fze4.setY(56);
        fym_04.X(fze4);
        ...
        fze5.setTexture(this.okR.uF("txChest"));
        fze5.setWidth(16);
        fze5.setX(4);
        fze5.setY(108);
        fym_05.X(fze5);
