...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        String string2 = "pmHudButtonMenuWhite75";
        ...
        fze3.setTexture(this.okR.uF("txHudButtonMenu"));
        fze3.setWidth(24);
        fze3.setX(0);
        fze3.setY(78);
        fym_02.X(fze3);
        ...
        String string4 = "pmHudButtonMenuPrimaryLight";
        ...
        fze5.setTexture(this.okR.uF("txHudButtonMenu"));
        fze5.setWidth(24);
        fze5.setX(0);
        fze5.setY(26);
        fym_03.X(fze5);
        ...
        String string6 = "pmHudButtonMenuWhite100";
        ...
        fze7.setTexture(this.okR.uF("txHudButtonMenu"));
        fze7.setWidth(24);
        fze7.setX(0);
        fze7.setY(52);
        fym_04.X(fze7);
        ...
        String string8 = "pmHudButtonMenuWhite25";
        ...
        fze9.setTexture(this.okR.uF("txHudButtonMenu"));
        fze9.setWidth(24);
        fze9.setX(0);
        fze9.setY(104);
        fym_05.X(fze9);
