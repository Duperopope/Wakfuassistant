...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fys_02);
        fys_02.guy();
        String string = "pmbBlueOverHeadProgressBarBackground";
        ...
        fze2.setTexture(this.okR.uF("txOverHeadProgressBarBackground"));
        fze2.setWidth(8);
        fze2.setX(0);
        fze2.setY(22);
        fkd_12.X(fze2);
        ...
        fze3.setTexture(this.okR.uF("txOverHeadProgressBarBackground"));
        fze3.setWidth(8);
        fze3.setX(0);
        fze3.setY(31);
        fkd_12.X(fze3);
        ...
        fze4.setTexture(this.okR.uF("txOverHeadProgressBarBackground"));
        fze4.setWidth(8);
        fze4.setX(0);
        fze4.setY(34);
        fkd_12.X(fze4);
        ...
        fze5.setTexture(this.okR.uF("txOverHeadProgressBarBackground"));
        fze5.setWidth(1);
        fze5.setX(9);
        fze5.setY(22);
        fkd_12.X(fze5);
        ...
        fze6.setTexture(this.okR.uF("txOverHeadProgressBarBackground"));
        fze6.setWidth(1);
        fze6.setX(9);
        fze6.setY(31);
        fkd_12.X(fze6);
        ...
        fze7.setTexture(this.okR.uF("txOverHeadProgressBarBackground"));
        fze7.setWidth(1);
        fze7.setX(9);
        fze7.setY(34);
        fkd_12.X(fze7);
        ...
        fze8.setTexture(this.okR.uF("txOverHeadProgressBarBackground"));
        fze8.setWidth(8);
        fze8.setX(12);
        fze8.setY(22);
        fkd_12.X(fze8);
        ...
        fze9.setTexture(this.okR.uF("txOverHeadProgressBarBackground"));
        fze9.setWidth(8);
        fze9.setX(12);
        fze9.setY(31);
        fkd_12.X(fze9);
        ...
        fze10.setTexture(this.okR.uF("txOverHeadProgressBarBackground"));
        fze10.setWidth(8);
        fze10.setX(12);
        fze10.setY(34);
        fkd_12.X(fze10);
