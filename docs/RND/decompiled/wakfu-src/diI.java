...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fym_02);
        fym_02.guy();
        String string = "compartmentArrowDownButton";
        ...
        fes_22.X(fym_03);
        fym_03.guy();
        String string2 = "compartmentArrowDownButtonOver";
        ...
        fes_22.X(fym_04);
        fym_04.guy();
        String string3 = "compartmentArrowDownButtonPressed";
        ...
        fes_22.X(fym_05);
        fym_05.guy();
        String string4 = "compartmentArrowDownButtonDisabled";
