...
extends afk_1 {
    ...
    @Override
    public afe_1[] bBg() {
        return new afe_1[]{new afe_1("type", "ClientInteractiveAnimatedElementSceneView GFX id", aff_2.dJy, false), new afe_1("posX", "Position x", aff_2.dJy, false), new afe_1("posY", "Position y", aff_2.dJy, false), new afe_1("posZ", "Position z", aff_2.dJy, true)};
    }
