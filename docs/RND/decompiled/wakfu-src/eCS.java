...
extends eak_0 {
    ...
    public eCS(ArrayList<amx_1> arrayList) {
        this.pzA = (amu_1)arrayList.get(0);
    }

    @Override
    public long d(Object object, Object object2, Object object3, Object object4) {
        long l = this.pzA.d(object, object2, object3, object4);
        Optional<foM> optional = eAs.l(object, object2, object3, object4);
        Integer n = optional.map(arg_0 -> eAs.pwd.apply(arg_0)).map(arg_0 -> eAs.pvY.apply(arg_0)).map(arg_0 -> eAs.pwa.apply(arg_0)).map(tIntObjectHashMap -> new eCT(l).d((TIntObjectHashMap<abm_1>)tIntObjectHashMap)).map(arg_0 -> eAs.pwc.apply(arg_0)).orElse(0);
