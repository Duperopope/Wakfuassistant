...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        String string = "pmMergeInventoryWhite100";
        ...
        fze2.setTexture(this.okR.uF("txMergeInventory"));
        fze2.setWidth(16);
        fze2.setX(2);
        fze2.setY(46);
        fym_02.X(fze2);
        ...
        fze3.setTexture(this.okR.uF("txSecondaryButtonSmall"));
        fze3.setWidth(36);
        fze3.setX(0);
        fze3.setY(0);
        fkd_12.X(fze3);
        ...
        String string3 = "pmMergeInventoryWhite100";
        ...
        fze4.setTexture(this.okR.uF("txMergeInventory"));
        fze4.setWidth(16);
        fze4.setX(2);
        fze4.setY(46);
        fym_03.X(fze4);
        ...
        fze5.setTexture(this.okR.uF("txSecondaryButtonSmall"));
        fze5.setWidth(36);
        fze5.setX(0);
        fze5.setY(38);
        fkd_13.X(fze5);
        ...
        String string5 = "pmMergeInventoryWhite100";
        ...
        fze6.setTexture(this.okR.uF("txMergeInventory"));
        fze6.setWidth(16);
        fze6.setX(2);
        fze6.setY(46);
        fym_04.X(fze6);
        ...
        fze7.setTexture(this.okR.uF("txSecondaryButtonSmall"));
        fze7.setWidth(36);
        fze7.setX(0);
        fze7.setY(76);
        fkd_14.X(fze7);
        ...
        String string7 = "pmMergeInventoryWhite25";
        ...
        fze8.setTexture(this.okR.uF("txMergeInventory"));
        fze8.setWidth(16);
        fze8.setX(2);
        fze8.setY(90);
        fym_05.X(fze8);
        ...
        fze9.setTexture(this.okR.uF("txSecondaryButtonSmall"));
        fze9.setWidth(36);
        fze9.setX(0);
        fze9.setY(114);
        fkd_15.X(fze9);
