...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fzs2.X(fkd_12);
        fkd_12.guy();
        String string = "pmStarBlack50Light";
        ...
        fze2.setTexture(this.okR.uF("txStar"));
        fze2.setWidth(16);
        fze2.setX(2);
        fze2.setY(200);
        fkd_12.X(fze2);
        ...
        fze3.setTexture(this.okR.uF("txStar"));
        fze3.setWidth(16);
        fze3.setX(2);
        fze3.setY(68);
        fkd_13.X(fze3);
        ...
        fze4.setTexture(this.okR.uF("txStar"));
        fze4.setWidth(16);
        fze4.setX(2);
        fze4.setY(46);
        fkd_14.X(fze4);
        ...
        fze5.setTexture(this.okR.uF("txStar"));
        fze5.setWidth(16);
        fze5.setX(2);
        fze5.setY(156);
        fkd_15.X(fze5);
        ...
        fzs6.X(fkd_16);
        fkd_16.guy();
        String string5 = "pmStarPrimaryLight";
        ...
        fze6.setTexture(this.okR.uF("txStar"));
        fze6.setWidth(16);
        fze6.setX(2);
        fze6.setY(24);
        fkd_16.X(fze6);
        ...
        fzs7.X(fkd_17);
        fkd_17.guy();
        String string6 = "pmStarPrimaryMedium";
        ...
        fze7.setTexture(this.okR.uF("txStar"));
        fze7.setWidth(16);
        fze7.setX(2);
        fze7.setY(2);
        fkd_17.X(fze7);
        ...
        fze8.setTexture(this.okR.uF("txStar"));
        fze8.setWidth(16);
        fze8.setX(2);
        fze8.setY(46);
        fkd_18.X(fze8);
        ...
        fze9.setTexture(this.okR.uF("txStar"));
        fze9.setWidth(16);
        fze9.setX(2);
        fze9.setY(156);
        fkd_19.X(fze9);
