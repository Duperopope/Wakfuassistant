...
extends ft_0 {
    ...
    private static final Logger hlk = Logger.getLogger(auc_0.class);
    ...
    public String a(String string, String string2, Object ... objectArray) {
        try {
            String string3 = fo_0.b(this.bS(string), objectArray);
            if (string3 != null && bl_0.bl(string3)) {
                return string3;
            }
            ...
            if (string2 != null) {
                return auc_0.kG(string2);
            }
            return null;
        }
        catch (fu_0 fu_02) {
            hlk.warn((Object)fu_02.getMessage());
            return null;
        }
    }
    ...
    public boolean h(String string, Object ... objectArray) {
        try {
            String string2 = fo_0.b(this.bS(string), objectArray);
            return string2 != null && bl_0.bl(string2);
        }
        catch (fu_0 fu_02) {
            hlk.warn((Object)("Unable to read icon with key " + string + " and args " + Arrays.toString(objectArray)), (Throwable)fu_02);
            return false;
        }
    }
    ...
    public String dd(int n, int n2) {
        try {
            return String.format(auc_0.cVq().bS(hmV), n, n2);
        }
        catch (fu_0 fu_02) {
            return null;
        }
    ...
    public String a(@Nullable fjm fjm2, @NotNull fhc_0 fhc_02) {
        if (fjm2 == null) {
            hlk.warn((Object)"Unable to fetch sex from a null citizen, we use default gfxId of item instead", (Throwable)new NullPointerException());
            return this.zx(fhc_02.aVt());
        }
        return this.zx(fjm2.aWO() == 1 ? fhc_02.cpf() : fhc_02.aVt());
    }
    ...
    public static String cVE() {
        try {
            ...
            hlk.warn((Object)"Could not find default icon at path defaultIconPath", (Throwable)fu_02);
            return null;
        }
    }
    ...
    public String kE(String string) {
        String string2 = this.a(hqk, null, string, aum_0.cWf().aUXX().aUP());
        if (bl_0.bl(string2)) {
            return string2;
        }
    ...
    public String cVG() {
        try {
            return String.format(this.bS(hqM), aum_0.cWf().aUXX().aUS());
        }
        catch (fu_0 fu_02) {
            hlk.error((Object)"Unable to retrieve url of game requirements.", (Throwable)fu_02);
            return null;
        }
    }
    ...
    public static String kG(String string) {
        return fo_0.bB(auc_0.cVq().bS(string));
    }

    public static String i(String string, Object ... objectArray) {
        String string2 = String.format(auc_0.cVq().bS(string), objectArray);
    ...
    public ArrayList<oo_0> cVI() {
        ArrayList<oo_0> arrayList = new ArrayList<oo_0>();
        try {
            ...
            if (stringArray.length == 2) {
                ...
                for (int i = 0; i < stringArray2.length; ++i) {
                    arrayList.add(new oo_0(string2, Integer.parseInt(stringArray2[i])));
                }
            }
        }
        catch (fu_0 fu_02) {
            hlk.error((Object)"PropertyException during getDispatchAddresses", (Throwable)fu_02);
        }
        return arrayList;
    }
}
