...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fym_02);
        fym_02.guy();
        String string = "pmbDefaultButtonHudMenu";
        ...
        fze2.setTexture(this.okR.uF("txHudMenuButton"));
        fze2.setWidth(36);
        fze2.setX(0);
        fze2.setY(38);
        fkd_12.X(fze2);
        ...
        String string2 = "pmHudButtonBattleFieldWhite75";
        ...
        fze3.setTexture(this.okR.uF("txHudButtonBattleField"));
        fze3.setWidth(24);
        fze3.setX(0);
        fze3.setY(78);
        fym_02.X(fze3);
        ...
        fes_22.X(fym_03);
        fym_03.guy();
        String string3 = "pmbHoverButtonHudMenu";
        ...
        fze4.setTexture(this.okR.uF("txHudMenuButton"));
        fze4.setWidth(36);
        fze4.setX(0);
        fze4.setY(76);
        fkd_13.X(fze4);
        ...
        String string4 = "pmHudButtonBattleFieldPrimaryLight";
        ...
        fze5.setTexture(this.okR.uF("txHudButtonBattleField"));
        fze5.setWidth(24);
        fze5.setX(0);
        fze5.setY(26);
        fym_03.X(fze5);
        ...
        fes_22.X(fym_04);
        fym_04.guy();
        String string5 = "pmbPressedButtonHudMenu";
        ...
        fze6.setTexture(this.okR.uF("txHudMenuButton"));
        fze6.setWidth(36);
        fze6.setX(0);
        fze6.setY(114);
        fkd_14.X(fze6);
        ...
        String string6 = "pmHudButtonBattleFieldWhite100";
        ...
        fze7.setTexture(this.okR.uF("txHudButtonBattleField"));
        fze7.setWidth(24);
        fze7.setX(0);
        fze7.setY(52);
        fym_04.X(fze7);
        ...
        fes_22.X(fym_05);
        fym_05.guy();
        String string7 = "pmbDisabledButtonHudMenu";
        ...
        fze8.setTexture(this.okR.uF("txHudMenuButton"));
        fze8.setWidth(36);
        fze8.setX(0);
        fze8.setY(0);
        fkd_15.X(fze8);
        ...
        String string8 = "pmHudButtonBattleFieldWhite25";
        ...
        fze9.setTexture(this.okR.uF("txHudButtonBattleField"));
        fze9.setWidth(24);
        fze9.setX(0);
        fze9.setY(104);
        fym_05.X(fze9);
