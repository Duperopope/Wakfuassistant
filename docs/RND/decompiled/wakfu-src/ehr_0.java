...
extends Lexer {
    ...
    private static final Logger pVD = Logger.getLogger(ehr_0.class);
    protected ehs_0 pVE = new ehs_0(this, (BaseRecognizer)this);
    ...
    public ehr_0(CharStream charStream) {
        this(charStream, new RecognizerSharedState());
    }

    public ehr_0(CharStream charStream, RecognizerSharedState recognizerSharedState) {
...
lbl122:
    ...
    static {
        ...
        pVS = new short[n][];
        for (int i = 0; i < n; ++i) {
            ehr_0.pVS[i] = DFA.unpackEncodedString((String)pVL[i]);
        }
    }
}
