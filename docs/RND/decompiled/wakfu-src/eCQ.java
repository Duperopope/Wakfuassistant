...
extends eak_0 {
    ...
    public eCQ(ArrayList<amx_1> arrayList) {
        this.pzy = (amu_1)arrayList.get(0);
    }

    @Override
    public long d(Object object, Object object2, Object object3, Object object4) {
        long l = this.pzy.d(object, object2, object3, object4);
        Optional<foM> optional = eAs.l(object, object2, object3, object4);
        Integer n = optional.map(arg_0 -> eAs.pwd.apply(arg_0)).map(arg_0 -> eAs.pvY.apply(arg_0)).map(arg_0 -> eAs.pvZ.apply(arg_0)).map(tIntObjectHashMap -> new eCR(l).d((TIntObjectHashMap<abm_1>)tIntObjectHashMap)).map(arg_0 -> eAs.pwb.apply(arg_0)).orElse(0);
