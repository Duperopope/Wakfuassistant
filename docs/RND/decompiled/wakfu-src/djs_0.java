...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        String string = "pmExploitsPrimaryMedium";
        ...
        fze2.setTexture(this.okR.uF("txExploits"));
        fze2.setWidth(16);
        fze2.setX(4);
        fze2.setY(4);
        fym_02.X(fze2);
        ...
        String string2 = "pmExploitsPrimaryLight";
        ...
        fze3.setTexture(this.okR.uF("txExploits"));
        fze3.setWidth(16);
        fze3.setX(4);
        fze3.setY(30);
        fym_03.X(fze3);
        ...
        String string3 = "pmExploitsWhite100";
        ...
        fze4.setTexture(this.okR.uF("txExploits"));
        fze4.setWidth(16);
        fze4.setX(4);
        fze4.setY(56);
        fym_04.X(fze4);
        ...
        String string4 = "pmExploitsWhite25";
        ...
        fze5.setTexture(this.okR.uF("txExploits"));
        fze5.setWidth(16);
        fze5.setX(4);
        fze5.setY(108);
        fym_05.X(fze5);
