...
implements fhk_1 {
    ...
    public fhi_2 a(fhu_1 fhu_12, fhs_2 fhs_22) {
        ...
        fax_12.setOffsetX(215.0f);
        fax_12.setOffsetY(-5.0f);
        ...
        fax_13.setOffsetX(-215.0f);
        fax_13.setOffsetY(-5.0f);
        ...
        fdy_12.setText("flvnslfvn sdlf bdflnb ldfn b");
        faw_22.X(fdy_12);
        fdy_12.guy();
        ...
        fzv3.setInsets(new Insets(0, 250, 30, 250));
        fzq2.X(fzv3);
        fzv3.guy();
