...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        String string = "pmHistoryLightPrimaryMedium";
        ...
        fze2.setTexture(this.okR.uF("txHistory"));
        fze2.setWidth(16);
        fze2.setX(2);
        fze2.setY(2);
        fym_02.X(fze2);
        ...
        String string2 = "pmHistoryPrimaryLight";
        ...
        fze3.setTexture(this.okR.uF("txHistory"));
        fze3.setWidth(16);
        fze3.setX(2);
        fze3.setY(24);
        fym_03.X(fze3);
        ...
        String string3 = "pmHistoryWhite100";
        ...
        fze4.setTexture(this.okR.uF("txHistory"));
        fze4.setWidth(16);
        fze4.setX(2);
        fze4.setY(46);
        fym_04.X(fze4);
        ...
        String string4 = "pmHistoryWhite25";
        ...
        fze5.setTexture(this.okR.uF("txHistory"));
        fze5.setWidth(16);
        fze5.setX(2);
        fze5.setY(90);
        fym_05.X(fze5);
