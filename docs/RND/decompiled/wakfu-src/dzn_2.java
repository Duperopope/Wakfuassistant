...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fze2.setTexture(this.okR.uF("txNegativeToast"));
        fze2.setWidth(32);
        fze2.setX(0);
        fze2.setY(0);
        fkd_12.X(fze2);
        ...
        fze3.setTexture(this.okR.uF("txNegativeToast"));
        fze3.setWidth(1);
        fze3.setX(32);
        fze3.setY(0);
        fkd_12.X(fze3);
        ...
        fze4.setTexture(this.okR.uF("txNegativeToast"));
        fze4.setWidth(32);
        fze4.setX(34);
        fze4.setY(0);
        fkd_12.X(fze4);
        ...
        fze5.setTexture(this.okR.uF("txNegativeToast"));
        fze5.setWidth(32);
        fze5.setX(34);
        fze5.setY(32);
        fkd_12.X(fze5);
        ...
        fze6.setTexture(this.okR.uF("txNegativeToast"));
        fze6.setWidth(32);
        fze6.setX(34);
        fze6.setY(34);
        fkd_12.X(fze6);
        ...
        fze7.setTexture(this.okR.uF("txNegativeToast"));
        fze7.setWidth(1);
        fze7.setX(32);
        fze7.setY(34);
        fkd_12.X(fze7);
        ...
        fze8.setTexture(this.okR.uF("txNegativeToast"));
        fze8.setWidth(32);
        fze8.setX(0);
        fze8.setY(34);
        fkd_12.X(fze8);
        ...
        fze9.setTexture(this.okR.uF("txNegativeToast"));
        fze9.setWidth(32);
        fze9.setX(0);
        fze9.setY(32);
        fkd_12.X(fze9);
        ...
        fze10.setTexture(this.okR.uF("txNegativeToast"));
        fze10.setWidth(1);
        fze10.setX(32);
        fze10.setY(32);
        fkd_12.X(fze10);
