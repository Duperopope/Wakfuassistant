...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fys_02);
        fys_02.guy();
        String string = "pmbItemTooltipCommonNoShadow";
        ...
        fze2.setTexture(this.okR.uF("txHeroBorder"));
        fze2.setWidth(32);
        fze2.setX(5);
        fze2.setY(5);
        fkd_12.X(fze2);
        ...
        fze3.setTexture(this.okR.uF("txHeroBorder"));
        fze3.setWidth(1);
        fze3.setX(37);
        fze3.setY(5);
        fkd_12.X(fze3);
        ...
        fze4.setTexture(this.okR.uF("txHeroBorder"));
        fze4.setWidth(35);
        fze4.setX(38);
        fze4.setY(5);
        fkd_12.X(fze4);
        ...
        fze5.setTexture(this.okR.uF("txHeroBorder"));
        fze5.setWidth(32);
        fze5.setX(5);
        fze5.setY(37);
        fkd_12.X(fze5);
        ...
        fze6.setTexture(this.okR.uF("txHeroBorder"));
        fze6.setWidth(1);
        fze6.setX(37);
        fze6.setY(37);
        fkd_12.X(fze6);
        ...
        fze7.setTexture(this.okR.uF("txHeroBorder"));
        fze7.setWidth(35);
        fze7.setX(38);
        fze7.setY(37);
        fkd_12.X(fze7);
        ...
        fze8.setTexture(this.okR.uF("txHeroBorder"));
        fze8.setWidth(32);
        fze8.setX(5);
        fze8.setY(38);
        fkd_12.X(fze8);
        ...
        fze9.setTexture(this.okR.uF("txHeroBorder"));
        fze9.setWidth(1);
        fze9.setX(37);
        fze9.setY(38);
        fkd_12.X(fze9);
        ...
        fze10.setTexture(this.okR.uF("txHeroBorder"));
        fze10.setWidth(35);
        fze10.setX(38);
        fze10.setY(38);
        fkd_12.X(fze10);
