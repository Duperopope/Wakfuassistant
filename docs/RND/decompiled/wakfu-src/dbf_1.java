...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fze2.setTexture(this.okR.uF("txWindowBackgroundSecondary"));
        fze2.setWidth(16);
        fze2.setX(0);
        fze2.setY(0);
        fkd_12.X(fze2);
        ...
        fze3.setTexture(this.okR.uF("txWindowBackgroundSecondary"));
        fze3.setWidth(1);
        fze3.setX(48);
        fze3.setY(0);
        fkd_12.X(fze3);
        ...
        fze4.setTexture(this.okR.uF("txWindowBackgroundSecondary"));
        fze4.setWidth(16);
        fze4.setX(48);
        fze4.setY(0);
        fkd_12.X(fze4);
        ...
        fze5.setTexture(this.okR.uF("txWindowBackgroundSecondary"));
        fze5.setWidth(16);
        fze5.setX(0);
        fze5.setY(48);
        fkd_12.X(fze5);
        ...
        fze6.setTexture(this.okR.uF("txWindowBackgroundSecondary"));
        fze6.setWidth(1);
        fze6.setX(48);
        fze6.setY(48);
        fkd_12.X(fze6);
        ...
        fze7.setTexture(this.okR.uF("txWindowBackgroundSecondary"));
        fze7.setWidth(16);
        fze7.setX(48);
        fze7.setY(48);
        fkd_12.X(fze7);
        ...
        fze8.setTexture(this.okR.uF("txWindowBackgroundSecondary"));
        fze8.setWidth(16);
        fze8.setX(0);
        fze8.setY(48);
        fkd_12.X(fze8);
        ...
        fze9.setTexture(this.okR.uF("txWindowBackgroundSecondary"));
        fze9.setWidth(1);
        fze9.setX(48);
        fze9.setY(48);
        fkd_12.X(fze9);
