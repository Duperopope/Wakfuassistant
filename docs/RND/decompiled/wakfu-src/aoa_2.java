...
public class aoa_2
extends aoh_1 {
    public static final String cLX = "cone";
    public static final aox_1 cLY = new aob_2(new aoa_1("Cone", new aou_1("height")));
    private int brt;
    private final List<int[]> cLZ = new ArrayList<int[]>(1);
