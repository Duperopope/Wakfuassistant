...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        String string = "pmRecycleLightPrimaryMedium";
        ...
        String string2 = "pmRecycleLightPrimaryLight";
        ...
        fze3.setTexture(this.okR.uF("txRecycle"));
        fze3.setWidth(16);
        fze3.setX(2);
        fze3.setY(24);
        fym_03.X(fze3);
        ...
        String string4 = "pmRecycleWhite25";
        ...
        fze5.setTexture(this.okR.uF("txRecycle"));
        fze5.setWidth(16);
        fze5.setX(2);
        fze5.setY(90);
        fym_05.X(fze5);
