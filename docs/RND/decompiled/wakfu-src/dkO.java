...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fze2.setTexture(this.okR.uF("txSecondaryButtonSmall"));
        fze2.setWidth(36);
        fze2.setX(0);
        fze2.setY(0);
        fkd_12.X(fze2);
        ...
        String string2 = "pmMagnifyingGlassPrimaryLight";
        ...
        fze3.setTexture(this.okR.uF("txMagnifyingGlass"));
        fze3.setWidth(16);
        fze3.setX(2);
        fze3.setY(24);
        fym_02.X(fze3);
        ...
        String string3 = "pmbHoverButtonSecondarySmall";
        ...
        fze4.setTexture(this.okR.uF("txSecondaryButtonSmall"));
        fze4.setWidth(36);
        fze4.setX(0);
        fze4.setY(38);
        fkd_13.X(fze4);
        ...
        String string4 = "pmMagnifyingGlassPrimaryLight";
        ...
        fze5.setTexture(this.okR.uF("txMagnifyingGlass"));
        fze5.setWidth(16);
        fze5.setX(2);
        fze5.setY(24);
        fym_03.X(fze5);
        ...
        String string5 = "pmbPressedButtonSecondarySmall";
        ...
        fze6.setTexture(this.okR.uF("txSecondaryButtonSmall"));
        fze6.setWidth(36);
        fze6.setX(0);
        fze6.setY(76);
        fkd_14.X(fze6);
        ...
        String string6 = "pmMagnifyingGlassWhite100";
        ...
        fze7.setTexture(this.okR.uF("txMagnifyingGlass"));
        fze7.setWidth(16);
        fze7.setX(2);
        fze7.setY(46);
        fym_04.X(fze7);
        ...
        String string7 = "pmbDisabledButtonSecondarySmall";
        ...
        fze8.setTexture(this.okR.uF("txSecondaryButtonSmall"));
        fze8.setWidth(36);
        fze8.setX(0);
        fze8.setY(114);
        fkd_15.X(fze8);
        ...
        String string8 = "pmMagnifyingGlassWhite25";
        ...
        fze9.setTexture(this.okR.uF("txMagnifyingGlass"));
        fze9.setWidth(16);
        fze9.setX(2);
        fze9.setY(90);
        fym_05.X(fze9);
