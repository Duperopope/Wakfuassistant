...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fys_02);
        fys_02.guy();
        String string = "pmbRedSlotOrnament";
        ...
        fze2.setTexture(this.okR.uF("txRedSlotOrnament"));
        fze2.setWidth(160);
        fze2.setX(0);
        fze2.setY(0);
        fkd_12.X(fze2);
        ...
        fze3.setTexture(this.okR.uF("txRedSlotOrnament"));
        fze3.setWidth(160);
        fze3.setX(0);
        fze3.setY(44);
        fkd_12.X(fze3);
        ...
        fze4.setTexture(this.okR.uF("txRedSlotOrnament"));
        fze4.setWidth(160);
        fze4.setX(0);
        fze4.setY(46);
        fkd_12.X(fze4);
        ...
        fze5.setTexture(this.okR.uF("txRedSlotOrnament"));
        fze5.setWidth(0);
        fze5.setX(0);
        fze5.setY(0);
        fkd_12.X(fze5);
        ...
        fze6.setTexture(this.okR.uF("txRedSlotOrnament"));
        fze6.setWidth(0);
        fze6.setX(0);
        fze6.setY(114);
        fkd_12.X(fze6);
        ...
        fze7.setTexture(this.okR.uF("txRedSlotOrnament"));
        fze7.setWidth(0);
        fze7.setX(0);
        fze7.setY(0);
        fkd_12.X(fze7);
        ...
        fze8.setTexture(this.okR.uF("txRedSlotOrnament"));
        fze8.setWidth(0);
        fze8.setX(0);
        fze8.setY(0);
        fkd_12.X(fze8);
        ...
        fze9.setTexture(this.okR.uF("txRedSlotOrnament"));
        fze9.setWidth(0);
        fze9.setX(0);
        fze9.setY(0);
        fkd_12.X(fze9);
        ...
        fze10.setTexture(this.okR.uF("txRedSlotOrnament"));
        fze10.setWidth(0);
        fze10.setX(0);
        fze10.setY(0);
        fkd_12.X(fze10);
