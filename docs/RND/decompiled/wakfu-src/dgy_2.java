...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fym_02);
        fym_02.guy();
        String string = "pmCaretBottomLightPrimaryMedium";
        ...
        fes_22.X(fym_03);
        fym_03.guy();
        String string2 = "pmCaretBottomPrimaryLight";
        ...
        fze3.setTexture(this.okR.uF("txCaretBottom"));
        fze3.setWidth(16);
        fze3.setX(2);
        fze3.setY(24);
        fym_03.X(fze3);
        ...
        fes_22.X(fym_04);
        fym_04.guy();
        String string3 = "pmCaretBottomWhite100";
        ...
        fes_22.X(fym_05);
        fym_05.guy();
        String string4 = "pmCaretBottomWhite25";
        ...
        fze5.setTexture(this.okR.uF("txCaretBottom"));
        fze5.setWidth(16);
        fze5.setX(2);
        fze5.setY(90);
        fym_05.X(fze5);
