...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fzs2);
        fzs2.guy();
        String string = "pmCompassButtonDefault";
        ...
        fze2.setTexture(this.okR.uF("txCompassButton"));
        fze2.setWidth(36);
        fze2.setX(0);
        fze2.setY(0);
        fzs2.X(fze2);
        ...
        fes_22.X(fzs3);
        fzs3.guy();
        String string2 = "pmCompassButtonHover";
        ...
        fze3.setTexture(this.okR.uF("txCompassButton"));
        fze3.setWidth(36);
        fze3.setX(0);
        fze3.setY(38);
        fzs3.X(fze3);
        ...
        fes_22.X(fzs4);
        fzs4.guy();
        String string3 = "pmCompassButtonPressed";
        ...
        fze4.setTexture(this.okR.uF("txCompassButton"));
        fze4.setWidth(36);
        fze4.setX(0);
        fze4.setY(76);
        fzs4.X(fze4);
        ...
        fes_22.X(fzs5);
        fzs5.guy();
        String string4 = "pmCompassButtonDisabled";
        ...
        fze5.setTexture(this.okR.uF("txCompassButton"));
        fze5.setWidth(36);
        fze5.setX(0);
        fze5.setY(114);
        fzs5.X(fze5);
        ...
        fes_22.X(fzs6);
        fzs6.guy();
        String string5 = "pmCompassButtonSelected";
        ...
        fze6.setTexture(this.okR.uF("txCompassButton"));
        fze6.setWidth(36);
        fze6.setX(0);
        fze6.setY(152);
        fzs6.X(fze6);
        ...
        fes_22.X(fzs7);
        fzs7.guy();
        String string6 = "pmCompassButtonSelectedHover";
        ...
        fze7.setTexture(this.okR.uF("txCompassButton"));
        fze7.setWidth(36);
        fze7.setX(0);
        fze7.setY(190);
        fzs7.X(fze7);
        ...
        fes_22.X(fzs8);
        fzs8.guy();
        String string7 = "pmCompassButtonSelectedPressed";
        ...
        fze8.setTexture(this.okR.uF("txCompassButton"));
        fze8.setWidth(36);
        fze8.setX(0);
        fze8.setY(228);
        fzs8.X(fze8);
        ...
        fes_22.X(fzs9);
        fzs9.guy();
        String string8 = "pmCompassButtonSelectedDisabled";
        ...
        fze9.setTexture(this.okR.uF("txCompassButton"));
        fze9.setWidth(36);
        fze9.setX(0);
        fze9.setY(266);
        fzs9.X(fze9);
