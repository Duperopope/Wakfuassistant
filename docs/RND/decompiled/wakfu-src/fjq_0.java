...
public class fjq_0
extends fjz_0 {
    private static final Logger szT = Logger.getLogger(fjq_0.class);
    public static final fja_0 szU = new fjr_0();
    private int epK;
    private int[] szV;
    ...
    public boolean aG(ByteBuffer byteBuffer) {
        ...
        if (n % 4 != 0) {
            szT.error((Object)"Impossible de d\u00e9s\u00e9rialiser une nationActionRequest. Nombre d'octets restants non valides pour former des entiers... pas multiple de 4.");
            return false;
        }
        int n2 = n / 4;
        this.szV = new int[n2];
