...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        String string2 = "pmUsePrimaryLight";
        ...
        fze3.setTexture(this.okR.uF("txUse"));
        fze3.setWidth(16);
        fze3.setX(2);
        fze3.setY(24);
        fym_02.X(fze3);
        ...
        String string4 = "pmUsePrimaryLight";
        ...
        fze5.setTexture(this.okR.uF("txUse"));
        fze5.setWidth(16);
        fze5.setX(2);
        fze5.setY(24);
        fym_03.X(fze5);
        ...
        fze7.setTexture(this.okR.uF("txUse"));
        fze7.setWidth(16);
        fze7.setX(2);
        fze7.setY(46);
        fym_04.X(fze7);
        ...
        fze9.setTexture(this.okR.uF("txUse"));
        fze9.setWidth(16);
        fze9.setX(2);
        fze9.setY(90);
        fym_05.X(fze9);
