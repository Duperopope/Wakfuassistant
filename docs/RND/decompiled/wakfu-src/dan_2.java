...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fze2.setTexture(this.okR.uF("txSelectorBorder"));
        fze2.setWidth(22);
        fze2.setX(0);
        fze2.setY(0);
        fkd_12.X(fze2);
        ...
        fze3.setTexture(this.okR.uF("txSelectorBorder"));
        fze3.setWidth(22);
        fze3.setX(0);
        fze3.setY(23);
        fkd_12.X(fze3);
        ...
        fze4.setTexture(this.okR.uF("txSelectorBorder"));
        fze4.setWidth(22);
        fze4.setX(0);
        fze4.setY(56);
        fkd_12.X(fze4);
        ...
        fze5.setTexture(this.okR.uF("txSelectorBorder"));
        fze5.setWidth(1);
        fze5.setX(23);
        fze5.setY(0);
        fkd_12.X(fze5);
        ...
        fze6.setTexture(this.okR.uF("txSelectorBorder"));
        fze6.setWidth(1);
        fze6.setX(39);
        fze6.setY(39);
        fkd_12.X(fze6);
        ...
        fze7.setTexture(this.okR.uF("txSelectorBorder"));
        fze7.setWidth(1);
        fze7.setX(23);
        fze7.setY(56);
        fkd_12.X(fze7);
        ...
        fze8.setTexture(this.okR.uF("txSelectorBorder"));
        fze8.setWidth(22);
        fze8.setX(56);
        fze8.setY(0);
        fkd_12.X(fze8);
        ...
        fze9.setTexture(this.okR.uF("txSelectorBorder"));
        fze9.setWidth(22);
        fze9.setX(56);
        fze9.setY(23);
        fkd_12.X(fze9);
        ...
        fze10.setTexture(this.okR.uF("txSelectorBorder"));
        fze10.setWidth(22);
        fze10.setX(56);
        fze10.setY(56);
        fkd_12.X(fze10);
