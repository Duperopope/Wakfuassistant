 ...
 * Renamed from eGS
 */
public final class egs_0
extends eak_0 {
    private static final ArrayList<amz_1[]> pET = new ArrayList();
    ...
    public egs_0(ArrayList<amx_1> arrayList) {
    ...
    public long d(Object object, Object object2, Object object3, Object object4) {
        ...
        int n = 0;
        Collection<QQ> collection = ety_02.bdh();
        for (QQ qQ : collection) {
            if (qQ.bci() != exP2 || !(qQ instanceof eSP)) continue;
            ++n;
        }
