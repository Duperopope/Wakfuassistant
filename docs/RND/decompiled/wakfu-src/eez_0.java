...
public class eez_0
extends eAH {
    private static final ArrayList<amz_1[]> pCH = new ArrayList();
    private final uw_0 pCI = new uw_0(0, 0, 0, 0, 0, 0);
    ...
    public eez_0(ArrayList<amx_1> arrayList) {
        this.r(arrayList);
        ...
        this.pCI.a(n6, n5, n4, n, n2, n3);
    }

    @Override
    public int a(Object object, Object object2, Object object3, Object object4) {
        if (ue_0.bjV().bjo() && ue_0.bjV().bjc().k(this.pCI) <= 0) {
            return 0;
        }
        return -1;
    }
