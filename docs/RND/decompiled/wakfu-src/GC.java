...
public class GC {
    public static final float aFY = (float)Math.PI;
    public static final Random aFZ;
    private static final CRC32 aGa;
    public static final float aGb = 1.0E-5f;
    public static final float aGc = (float)Math.PI * 2;
    public static final float aGd = (float)Math.PI;
    public static final float aGe = 1.5707964f;
    public static final float aGf = 1.0471976f;
    public static final float aGg = 0.7853982f;
    public static final float aGh = 0.5235988f;
    public static final float aGi = 0.3926991f;
    public static final float aGj = (float)Math.PI / 180;
    public static final float aGk = 57.29578f;
    public static final double aGl;
    public static final float aGm;
    private static final float[] aGn;
    private static final float[] aGo;
    private static int aGp;
    private static int aGq;
    private static final float[][] aGr;
    private static final float[][] aGs;
    ...
    public static int aNH() {
        return aFZ.nextInt() >> 1;
    }

    public static int p(int n, int n2) {
        return n - n2 + aFZ.nextInt(2 * n2);
    }

    public static void dj(byte[] byArray) {
        aFZ.nextBytes(byArray);
    }

    public static boolean aNI() {
        return aFZ.nextBoolean();
    }

    public static float aNJ() {
        return aFZ.nextFloat();
    }

    public static double aNK() {
        return aFZ.nextDouble();
    }
    ...
    public static long b(long l, long l2) {
        ...
        return Math.abs(aFZ.nextLong() % (l2 - l)) + l;
    }
    ...
    public static float b(float f2, float f3) {
        ...
        return aFZ.nextFloat() * (f3 - f2) + f2;
    }

    public static <T> Optional<T> h(@NotNull List<T> list) {
        if (list.isEmpty()) {
            return Optional.empty();
        }
        return Optional.ofNullable(list.get(GC.mR(list.size())));
    }

    public static Optional<Integer> f(int @NotNull [] nArray) {
        if (nArray.length == 0) {
            return Optional.empty();
        }
        return Optional.of(nArray[GC.mR(nArray.length)]);
    }
    ...
    public static float z(float f2) {
        ...
        return Math.signum(f2) * (f3 - (float)GC.B(f3));
    }

    public static double d(double d2) {
        double d3 = Math.abs(d2);
        return Math.signum(d2) * (d3 - (double)GC.f(d3));
    }
    ...
    public static double b(double d2, int n) {
    ...
    public static double c(double d2, int n) {
        BigDecimal bigDecimal = new BigDecimal(d2);
        bigDecimal = bigDecimal.round(new MathContext(n));
    ...
    public static byte c(byte by, byte by2) {
    ...
    public static byte a(byte by, byte by2, byte by3) {
        return GC.c(GC.b(by, by2), by3);
    }

    public static byte ct(long l) {
        return (byte)GC.a(l, -128L, 127L);
    }

    public static short cu(long l) {
        return (short)GC.a(l, -32768L, 32767L);
    }

    public static short cv(long l) {
        return (short)GC.a(l, 0L, 32767L);
    }

    public static int cw(long l) {
        return (int)GC.a(l, Integer.MIN_VALUE, Integer.MAX_VALUE);
    }

    public static int cx(long l) {
        return (int)GC.a(l, 0L, Integer.MAX_VALUE);
    }

    public static long s(int n, int n2) {
        long l = (long)n & 0xFFFFFFFFL;
        long l2 = (long)n2 & 0xFFFFFFFFL;
        return l << 32 | l2;
    }

    public static int cy(long l) {
        return (int)(l >> 32 & 0xFFFFFFFFL);
    }

    public static int cz(long l) {
    ...
    public static short d(byte by, byte by2) {
        short s = (short)((short)by & 0xFF);
        short s2 = (short)((short)by2 & 0xFF);
        return (short)(s << 8 | s2);
    }
    ...
    public static short mS(int n) {
        return (short)(n >> 16 & 0xFFFF);
    }

    public static short mT(int n) {
        return (short)(n & 0xFFFF);
    }

    public static boolean e(float f2, float f3) {
        return GC.c(f2, f3, 1.0E-5f);
    }
    ...
    public static boolean h(double d2) {
        return GC.c(d2, 0.0, (double)1.0E-5f);
    }

    public static boolean c(double d2, double d3, double d4) {
        return GC.f(d2 / d4) == GC.f(d3 / d4);
    }
    ...
    public static long f(long l, int n) {
        long l2 = 1L;
        for (int i = 0; i < n; ++i) {
            l2 *= l;
        }
    ...
    public static float M(float f2) {
        return (float)(Math.log(f2) / aGl);
    }

    public static double k(double d2) {
        return Math.log(d2) / aGl;
    }
    ...
    public static Random aNL() {
        return aFZ;
    }

    @Deprecated
    public static int cy(String string) {
        aGa.reset();
        aGa.update(string.getBytes());
        return (int)aGa.getValue();
    }
    ...
    public static boolean g(long l, int n) {
        assert (n >= 0 && n < 64);
        return (l >> n & 1L) == 1L;
    }
    ...
    public static boolean a(short s, int n) {
        assert (n >= 0 && n < 16);
        return (s >> n & 1) == 1;
    }

    public static short a(short s, int n, boolean bl) {
        assert (n >= 0 && n < 16);
        s = bl ? (short)(s | 1 << n) : (short)(s & ~(1 << n));
        return s;
    }
