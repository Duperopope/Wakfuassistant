 ...
 * Renamed from bbb
 */
public final class bbb_0
extends eSP
implements ado_0,
bbC,
bbD {
    private static final short hzN = 1;
    private int egP;
    private final bby hzO;
    private adj_0 hzI;

    private bbb_0() {
        this.hzO = new bbB(this).daf();
        this.hzO.a(new bbd_0());
    }

    public bbb_0(int n, aoh_1 aoh_12, BitSet bitSet, BitSet bitSet2, int n2, int n3, int n4, float[] fArray, String string, String string2, String string3, String string4, float[] fArray2, boolean bl, boolean bl2, int n5) {
    ...
    public bbb_0 h(etj_0 etj_02) {
        bbb_0 bbb_02 = (bbb_0)super.b(etj_02);
        bbb_02.egP = this.egP;
        bbb_02.hzO.b(this.hzO);
        bbb_02.aPg();
        return bbb_02;
    }
