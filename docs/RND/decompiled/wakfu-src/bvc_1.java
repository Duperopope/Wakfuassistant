...
extends afk_1 {
    ...
    public void ss(int n) {
        ...
        afq_2[] afq_2Array2 = new afq_2[n2 + 1];
        if (n2 != 0) {
            System.arraycopy(afq_2Array, 0, afq_2Array2, 1, afq_2Array.length);
        }
        ...
        bfv_0.dTx().bX((byte)2);
        bfv_0.dTx().a(new bvd_2(this, afq_2Array2, afx_12, n3));
