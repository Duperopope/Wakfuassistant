...
extends alv_1<alp_1<alq_1>> {
    public static final String cFS = "playRandomSound";
    private static final afe_1[] cFT = new afe_1[]{new afe_1("stopOnAnimationChange", null, aff_2.dJA, false), new afe_1("soundId, gain", null, aff_2.dJC, true)};

    public alk_1(ZC zC, LuaState luaState, Logger logger) {
    ...
    protected alp_1<alq_1> sV(int n) {
        ...
        List<alq_1> list = this.g(1, n, false);
    ...
    public void a(alp_1<alq_1> alp_12, afx_1 afx_12) {
        ...
        try {
            if (l != 0L) {
                ahm_1 ahm_12 = aiv_2.bBr().a(l, (float)n / 100.0f, alq_12.bBN(), 1, -1L, -1L, afx_12.bha(), this.c(afx_12));
