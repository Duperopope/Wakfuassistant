...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fys_02);
        fys_02.guy();
        String string = "pmbMinimapBorder";
        ...
        fze2.setTexture(this.okR.uF("txMinimapBorder"));
        fze2.setWidth(10);
        fze2.setX(0);
        fze2.setY(0);
        fkd_12.X(fze2);
        ...
        fze3.setTexture(this.okR.uF("txMinimapBorder"));
        fze3.setWidth(10);
        fze3.setX(0);
        fze3.setY(10);
        fkd_12.X(fze3);
        ...
        fze4.setTexture(this.okR.uF("txMinimapBorder"));
        fze4.setWidth(10);
        fze4.setX(0);
        fze4.setY(20);
        fkd_12.X(fze4);
        ...
        fze5.setTexture(this.okR.uF("txMinimapBorder"));
        fze5.setWidth(1);
        fze5.setX(10);
        fze5.setY(0);
        fkd_12.X(fze5);
        ...
        fze6.setTexture(this.okR.uF("txMinimapBorder"));
        fze6.setWidth(1);
        fze6.setX(10);
        fze6.setY(10);
        fkd_12.X(fze6);
        ...
        fze7.setTexture(this.okR.uF("txMinimapBorder"));
        fze7.setWidth(1);
        fze7.setX(10);
        fze7.setY(20);
        fkd_12.X(fze7);
        ...
        fze8.setTexture(this.okR.uF("txMinimapBorder"));
        fze8.setWidth(10);
        fze8.setX(22);
        fze8.setY(0);
        fkd_12.X(fze8);
        ...
        fze9.setTexture(this.okR.uF("txMinimapBorder"));
        fze9.setWidth(10);
        fze9.setX(22);
        fze9.setY(10);
        fkd_12.X(fze9);
        ...
        fze10.setTexture(this.okR.uF("txMinimapBorder"));
        fze10.setWidth(10);
        fze10.setX(22);
        fze10.setY(20);
        fkd_12.X(fze10);
