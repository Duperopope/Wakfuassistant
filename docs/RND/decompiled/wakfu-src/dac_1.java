...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fze2.setTexture(this.okR.uF("txOldRarityBorder"));
        fze2.setWidth(20);
        fze2.setX(0);
        fze2.setY(62);
        fkd_12.X(fze2);
        ...
        fze3.setTexture(this.okR.uF("txOldRarityBorder"));
        fze3.setWidth(1);
        fze3.setX(30);
        fze3.setY(62);
        fkd_12.X(fze3);
        ...
        fze4.setTexture(this.okR.uF("txOldRarityBorder"));
        fze4.setWidth(20);
        fze4.setX(40);
        fze4.setY(62);
        fkd_12.X(fze4);
        ...
        fze5.setTexture(this.okR.uF("txOldRarityBorder"));
        fze5.setWidth(20);
        fze5.setX(0);
        fze5.setY(92);
        fkd_12.X(fze5);
        ...
        fze6.setTexture(this.okR.uF("txOldRarityBorder"));
        fze6.setWidth(1);
        fze6.setX(30);
        fze6.setY(92);
        fkd_12.X(fze6);
        ...
        fze7.setTexture(this.okR.uF("txOldRarityBorder"));
        fze7.setWidth(20);
        fze7.setX(40);
        fze7.setY(92);
        fkd_12.X(fze7);
        ...
        fze8.setTexture(this.okR.uF("txOldRarityBorder"));
        fze8.setWidth(20);
        fze8.setX(0);
        fze8.setY(102);
        fkd_12.X(fze8);
        ...
        fze9.setTexture(this.okR.uF("txOldRarityBorder"));
        fze9.setWidth(1);
        fze9.setX(30);
        fze9.setY(102);
        fkd_12.X(fze9);
        ...
        fze10.setTexture(this.okR.uF("txOldRarityBorder"));
        fze10.setWidth(20);
        fze10.setX(40);
        fze10.setY(102);
        fkd_12.X(fze10);
