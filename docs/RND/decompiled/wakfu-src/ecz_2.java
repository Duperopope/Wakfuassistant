...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fzk2);
        fzk2.guy();
        String string = "pmDefaultSelectedChatFilterCheckBox";
        ...
        fes_22.X(fzk3);
        fzk3.guy();
        String string2 = "pmHoverSelectedChatFilterCheckBox";
        ...
        fes_22.X(fzk5);
        fzk5.guy();
        String string4 = "pmDefaultSelectedChatFilterCheckBox";
        ...
        fes_22.X(fzk9);
        fzk9.guy();
        String string8 = "pmDefaultSelectedChatFilterCheckBox";
