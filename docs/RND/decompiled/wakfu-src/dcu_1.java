...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fyY2);
        fyY2.guy();
        String string = "pmbAllyBackground";
        ...
        fze2.setTexture(this.okR.uF("txAllyBackground"));
        fze2.setWidth(15);
        fze2.setX(0);
        fze2.setY(0);
        fkd_12.X(fze2);
        ...
        fze3.setTexture(this.okR.uF("txAllyBackground"));
        fze3.setWidth(15);
        fze3.setX(0);
        fze3.setY(16);
        fkd_12.X(fze3);
        ...
        fze4.setTexture(this.okR.uF("txAllyBackground"));
        fze4.setWidth(15);
        fze4.setX(0);
        fze4.setY(17);
        fkd_12.X(fze4);
        ...
        fze5.setTexture(this.okR.uF("txAllyBackground"));
        fze5.setWidth(1);
        fze5.setX(16);
        fze5.setY(0);
        fkd_12.X(fze5);
        ...
        fze6.setTexture(this.okR.uF("txAllyBackground"));
        fze6.setWidth(1);
        fze6.setX(16);
        fze6.setY(16);
        fkd_12.X(fze6);
        ...
        fze7.setTexture(this.okR.uF("txAllyBackground"));
        fze7.setWidth(1);
        fze7.setX(16);
        fze7.setY(17);
        fkd_12.X(fze7);
        ...
        fze8.setTexture(this.okR.uF("txAllyBackground"));
        fze8.setWidth(15);
        fze8.setX(17);
        fze8.setY(0);
        fkd_12.X(fze8);
        ...
        fze9.setTexture(this.okR.uF("txAllyBackground"));
        fze9.setWidth(15);
        fze9.setX(17);
        fze9.setY(16);
        fkd_12.X(fze9);
        ...
        fze10.setTexture(this.okR.uF("txAllyBackground"));
        fze10.setWidth(15);
        fze10.setX(17);
        fze10.setY(17);
        fkd_12.X(fze10);
