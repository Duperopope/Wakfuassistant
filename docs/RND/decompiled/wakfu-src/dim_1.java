...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        String string = "pmCompassPrimaryMedium";
        ...
        fze2.setTexture(this.okR.uF("txCompass"));
        fze2.setWidth(16);
        fze2.setX(2);
        fze2.setY(2);
        fym_02.X(fze2);
        ...
        String string3 = "pmCompassWhite100";
        ...
        fze4.setTexture(this.okR.uF("txCompass"));
        fze4.setWidth(16);
        fze4.setX(2);
        fze4.setY(46);
        fym_04.X(fze4);
        ...
        String string4 = "pmCompassWhite25";
