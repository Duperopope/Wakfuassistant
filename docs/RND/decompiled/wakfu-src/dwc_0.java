...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fys_02);
        fys_02.guy();
        String string = "pmbChatBackground";
        ...
        fze2.setTexture(this.okR.uF("txChatBackground"));
        fze2.setWidth(5);
        fze2.setX(0);
        fze2.setY(0);
        fkd_12.X(fze2);
        ...
        fze3.setTexture(this.okR.uF("txChatBackground"));
        fze3.setWidth(5);
        fze3.setX(0);
        fze3.setY(6);
        fkd_12.X(fze3);
        ...
        fze4.setTexture(this.okR.uF("txChatBackground"));
        fze4.setWidth(5);
        fze4.setX(0);
        fze4.setY(15);
        fkd_12.X(fze4);
        ...
        fze5.setTexture(this.okR.uF("txChatBackground"));
        fze5.setWidth(1);
        fze5.setX(6);
        fze5.setY(0);
        fkd_12.X(fze5);
        ...
        fze6.setTexture(this.okR.uF("txChatBackground"));
        fze6.setWidth(1);
        fze6.setX(6);
        fze6.setY(6);
        fkd_12.X(fze6);
        ...
        fze7.setTexture(this.okR.uF("txChatBackground"));
        fze7.setWidth(1);
        fze7.setX(6);
        fze7.setY(15);
        fkd_12.X(fze7);
        ...
        fze8.setTexture(this.okR.uF("txChatBackground"));
        fze8.setWidth(5);
        fze8.setX(15);
        fze8.setY(0);
        fkd_12.X(fze8);
        ...
        fze9.setTexture(this.okR.uF("txChatBackground"));
        fze9.setWidth(5);
        fze9.setX(15);
        fze9.setY(6);
        fkd_12.X(fze9);
        ...
        fze10.setTexture(this.okR.uF("txChatBackground"));
        fze10.setWidth(5);
        fze10.setX(15);
        fze10.setY(15);
        fkd_12.X(fze10);
