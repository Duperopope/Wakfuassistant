...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fys_02);
        fys_02.guy();
        String string = "pmbItemTooltipCommon";
        ...
        fze2.setTexture(this.okR.uF("txItemTooltipBorderCommon"));
        fze2.setWidth(37);
        fze2.setX(0);
        fze2.setY(0);
        fkd_12.X(fze2);
        ...
        fze3.setTexture(this.okR.uF("txItemTooltipBorderCommon"));
        fze3.setWidth(37);
        fze3.setX(0);
        fze3.setY(37);
        fkd_12.X(fze3);
        ...
        fze4.setTexture(this.okR.uF("txItemTooltipBorderCommon"));
        fze4.setWidth(37);
        fze4.setX(0);
        fze4.setY(41);
        fkd_12.X(fze4);
        ...
        fze5.setTexture(this.okR.uF("txItemTooltipBorderCommon"));
        fze5.setWidth(1);
        fze5.setX(37);
        fze5.setY(0);
        fkd_12.X(fze5);
        ...
        fze6.setTexture(this.okR.uF("txItemTooltipBorderCommon"));
        fze6.setWidth(1);
        fze6.setX(38);
        fze6.setY(38);
        fkd_12.X(fze6);
        ...
        fze7.setTexture(this.okR.uF("txItemTooltipBorderCommon"));
        fze7.setWidth(1);
        fze7.setX(37);
        fze7.setY(41);
        fkd_12.X(fze7);
        ...
        fze8.setTexture(this.okR.uF("txItemTooltipBorderCommon"));
        fze8.setWidth(37);
        fze8.setX(41);
        fze8.setY(0);
        fkd_12.X(fze8);
        ...
        fze9.setTexture(this.okR.uF("txItemTooltipBorderCommon"));
        fze9.setWidth(37);
        fze9.setX(41);
        fze9.setY(41);
        fkd_12.X(fze9);
        ...
        fze10.setTexture(this.okR.uF("txItemTooltipBorderCommon"));
        fze10.setWidth(37);
        fze10.setX(41);
        fze10.setY(41);
        fkd_12.X(fze10);
