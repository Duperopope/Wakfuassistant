...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fze2.setTexture(this.okR.uF("txContentContainer2"));
        fze2.setWidth(16);
        fze2.setX(0);
        fze2.setY(0);
        fkd_12.X(fze2);
        ...
        fze3.setTexture(this.okR.uF("txContentContainer2"));
        fze3.setWidth(1);
        fze3.setX(16);
        fze3.setY(0);
        fkd_12.X(fze3);
        ...
        fze4.setTexture(this.okR.uF("txContentContainer2"));
        fze4.setWidth(16);
        fze4.setX(16);
        fze4.setY(0);
        fkd_12.X(fze4);
        ...
        fze5.setTexture(this.okR.uF("txContentContainer2"));
        fze5.setWidth(16);
        fze5.setX(0);
        fze5.setY(16);
        fkd_12.X(fze5);
        ...
        fze6.setTexture(this.okR.uF("txContentContainer2"));
        fze6.setWidth(1);
        fze6.setX(16);
        fze6.setY(16);
        fkd_12.X(fze6);
        ...
        fze7.setTexture(this.okR.uF("txContentContainer2"));
        fze7.setWidth(16);
        fze7.setX(16);
        fze7.setY(16);
        fkd_12.X(fze7);
        ...
        fze8.setTexture(this.okR.uF("txContentContainer2"));
        fze8.setWidth(16);
        fze8.setX(0);
        fze8.setY(16);
        fkd_12.X(fze8);
        ...
        fze9.setTexture(this.okR.uF("txContentContainer2"));
        fze9.setWidth(1);
        fze9.setX(16);
        fze9.setY(16);
        fkd_12.X(fze9);
        ...
        fze10.setTexture(this.okR.uF("txContentContainer2"));
        fze10.setWidth(16);
        fze10.setX(16);
        fze10.setY(16);
        fkd_12.X(fze10);
