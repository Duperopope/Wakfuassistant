...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fym_02);
        fym_02.guy();
        String string = "pmPalettePrimaryMedium";
        ...
        fze2.setTexture(this.okR.uF("txPalette"));
        fze2.setWidth(16);
        fze2.setX(2);
        fze2.setY(2);
        fym_02.X(fze2);
        ...
        fes_22.X(fym_03);
        fym_03.guy();
        String string2 = "pmPalettePrimaryLight";
        ...
        fze3.setTexture(this.okR.uF("txPalette"));
        fze3.setWidth(16);
        fze3.setX(2);
        fze3.setY(24);
        fym_03.X(fze3);
        ...
        fes_22.X(fym_04);
        fym_04.guy();
        String string3 = "pmPaletteWhite100";
        ...
        fze4.setTexture(this.okR.uF("txPalette"));
        fze4.setWidth(16);
        fze4.setX(2);
        fze4.setY(46);
        fym_04.X(fze4);
        ...
        fes_22.X(fym_05);
        fym_05.guy();
        String string4 = "pmPaletteWhite25";
        ...
        fze5.setTexture(this.okR.uF("txPalette"));
        fze5.setWidth(16);
        fze5.setX(2);
        fze5.setY(90);
        fym_05.X(fze5);
