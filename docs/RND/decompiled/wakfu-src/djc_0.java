...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fze2.setTexture(this.okR.uF("txCross"));
        fze2.setWidth(16);
        fze2.setX(2);
        fze2.setY(46);
        fym_02.X(fze2);
        ...
        String string2 = "pmbDefaultSecondaryNegativeFloatingButton";
        ...
        fze3.setTexture(this.okR.uF("txSecondaryNegativeFloatingButton"));
        fze3.setWidth(24);
        fze3.setX(0);
        fze3.setY(0);
        fkd_12.X(fze3);
        ...
        fes_22.X(fym_03);
        fym_03.guy();
        String string3 = "pmCrossWhite100";
        ...
        fze4.setTexture(this.okR.uF("txCross"));
        fze4.setWidth(16);
        fze4.setX(2);
        fze4.setY(46);
        fym_03.X(fze4);
        ...
        String string4 = "pmbHoverSecondaryNegativeFloatingButton";
        ...
        fze5.setTexture(this.okR.uF("txSecondaryNegativeFloatingButton"));
        fze5.setWidth(24);
        fze5.setX(0);
        fze5.setY(26);
        fkd_13.X(fze5);
        ...
        fes_22.X(fym_04);
        fym_04.guy();
        String string5 = "pmCrossWhite100";
        ...
        fze6.setTexture(this.okR.uF("txCross"));
        fze6.setWidth(16);
        fze6.setX(2);
        fze6.setY(46);
        fym_04.X(fze6);
        ...
        String string6 = "pmbPressedSecondaryNegativeFloatingButton";
        ...
        fze7.setTexture(this.okR.uF("txSecondaryNegativeFloatingButton"));
        fze7.setWidth(24);
        fze7.setX(0);
        fze7.setY(52);
        fkd_14.X(fze7);
        ...
        fes_22.X(fym_05);
        fym_05.guy();
        String string7 = "pmCrossWhite100";
        ...
        fze8.setTexture(this.okR.uF("txCross"));
        fze8.setWidth(16);
        fze8.setX(2);
        fze8.setY(46);
        fym_05.X(fze8);
        ...
        String string8 = "pmbDisabledSecondaryNegativeFloatingButton";
        ...
        fze9.setTexture(this.okR.uF("txSecondaryNegativeFloatingButton"));
        fze9.setWidth(24);
        fze9.setX(0);
        fze9.setY(78);
        fkd_15.X(fze9);
