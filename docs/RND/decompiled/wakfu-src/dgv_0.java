...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fym_02);
        fym_02.guy();
        String string = "pmCompanionAddDefault";
        ...
        fze2.setTexture(this.okR.uF("txCompanionAdd"));
        fze2.setWidth(52);
        fze2.setX(0);
        fze2.setY(0);
        fym_02.X(fze2);
        ...
        fes_22.X(fym_03);
        fym_03.guy();
        String string2 = "pmCompanionAddHover";
        ...
        fze3.setTexture(this.okR.uF("txCompanionAdd"));
        fze3.setWidth(52);
        fze3.setX(0);
        fze3.setY(54);
        fym_03.X(fze3);
        ...
        fes_22.X(fym_04);
        fym_04.guy();
        String string3 = "pmCompanionAddPressed";
        ...
        fze4.setTexture(this.okR.uF("txCompanionAdd"));
        fze4.setWidth(52);
        fze4.setX(0);
        fze4.setY(108);
        fym_04.X(fze4);
        ...
        fes_22.X(fym_05);
        fym_05.guy();
        String string4 = "pmCompanionAddDefault";
        ...
        fze5.setTexture(this.okR.uF("txCompanionAdd"));
        fze5.setWidth(52);
        fze5.setX(0);
        fze5.setY(0);
        fym_05.X(fze5);
