...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fze2.setTexture(this.okR.uF("txPlus"));
        fze2.setWidth(18);
        fze2.setX(0);
        fze2.setY(80);
        fym_02.X(fze2);
        ...
        fze3.setTexture(this.okR.uF("txPlus"));
        fze3.setWidth(18);
        fze3.setX(0);
        fze3.setY(80);
        fym_03.X(fze3);
        ...
        fze4.setTexture(this.okR.uF("txPlus"));
        fze4.setWidth(18);
        fze4.setX(0);
        fze4.setY(20);
        fym_04.X(fze4);
        ...
        fze5.setTexture(this.okR.uF("txPlus"));
        fze5.setWidth(18);
        fze5.setX(0);
        fze5.setY(60);
        fym_05.X(fze5);
