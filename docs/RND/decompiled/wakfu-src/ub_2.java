...
final class ub_2 {
    private short adx = 0;
    private final uy_1 adz = new uy_1();
    final /* synthetic */ ua_2 adA;
    ...
    public void avW() {
        this.adA.adx = this.adx;
        this.adA.ady.ZC = this.adz.ZC;
        this.adA.ady.aaQ = this.adz.aaQ;
        this.adA.ady.aaa = this.adz.aaa;
        this.adA.ady.aeF = this.adz.aeF;
        this.adA.ady.aeG = this.adz.aeG;
        this.adA.ady.aeH = this.adz.aeH;
        this.adA.ady.aeI = this.adz.aeI;
        this.adA.ady.aeJ = this.adz.aeJ;
        this.adA.ady.aeK = this.adz.aeK;
        this.adA.ady.aeL = this.adz.aeL;
        this.adA.ady.aeM = this.adz.aeM;
    }
    ...
    private boolean cx(ByteBuffer byteBuffer) {
        ...
        boolean bl = this.adz.b(byteBuffer, 1);
        return bl;
    }

    private boolean cG(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.adz.b(byteBuffer, 313);
        return bl;
    }

    private boolean cH(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.adz.b(byteBuffer, 314);
        return bl;
    }

    private boolean cI(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.adz.b(byteBuffer, 315);
        return bl;
    }

    private boolean cJ(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.adz.b(byteBuffer, 10003);
        return bl;
    }

    private boolean cL(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.adz.b(byteBuffer, 10023);
        return bl;
    }

    private boolean cM(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.adz.b(byteBuffer, 10028000);
        return bl;
    }

    private boolean cN(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.adz.b(byteBuffer, 10029000);
        return bl;
    }

    private boolean cO(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.adz.b(byteBuffer, 10032003);
        return bl;
    }

    private boolean cP(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.adz.b(byteBuffer, 10035004);
        return bl;
    }

    private boolean cQ(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.adz.b(byteBuffer, 10035007);
        return bl;
    }

    private boolean cR(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.adz.b(byteBuffer, 10036004);
        return bl;
    }

    private boolean cS(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.adz.b(byteBuffer, 10037001);
        return bl;
    }

    private boolean cT(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.adz.b(byteBuffer, 10040005);
        return bl;
    }

    private boolean cU(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.adz.b(byteBuffer, 10045010);
        return bl;
    }

    private boolean cC(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.adz.b(byteBuffer, 10048000);
        return bl;
    }

    private boolean cV(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.adz.b(byteBuffer, 10055001);
        return bl;
    }

    private boolean cW(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.adz.b(byteBuffer, 10064001);
        return bl;
    }

    private boolean cX(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.adz.b(byteBuffer, 10066001);
        return bl;
    }
