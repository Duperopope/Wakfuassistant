...
final class vw_1 {
    private short adx = 0;
    private final uy_1 afv = new uy_1();
    final /* synthetic */ vv_2 afw;
    ...
    public void avW() {
        this.afw.adx = this.adx;
        this.afw.afu.ZC = this.afv.ZC;
        this.afw.afu.aaQ = this.afv.aaQ;
        this.afw.afu.aaa = this.afv.aaa;
        this.afw.afu.aeF = this.afv.aeF;
        this.afw.afu.aeG = this.afv.aeG;
        this.afw.afu.aeH = this.afv.aeH;
        this.afw.afu.aeI = this.afv.aeI;
        this.afw.afu.aeJ = this.afv.aeJ;
        this.afw.afu.aeK = this.afv.aeK;
        this.afw.afu.aeL = this.afv.aeL;
        this.afw.afu.aeM = this.afv.aeM;
    }
    ...
    private boolean cx(ByteBuffer byteBuffer) {
        ...
        boolean bl = this.afv.b(byteBuffer, 1);
        return bl;
    }

    private boolean cG(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.afv.b(byteBuffer, 313);
        return bl;
    }

    private boolean cH(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.afv.b(byteBuffer, 314);
        return bl;
    }

    private boolean cI(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.afv.b(byteBuffer, 315);
        return bl;
    }

    private boolean cJ(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.afv.b(byteBuffer, 10003);
        return bl;
    }

    private boolean cL(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.afv.b(byteBuffer, 10023);
        return bl;
    }

    private boolean cM(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.afv.b(byteBuffer, 10028000);
        return bl;
    }

    private boolean cN(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.afv.b(byteBuffer, 10029000);
        return bl;
    }

    private boolean cO(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.afv.b(byteBuffer, 10032003);
        return bl;
    }

    private boolean cP(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.afv.b(byteBuffer, 10035004);
        return bl;
    }

    private boolean cQ(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.afv.b(byteBuffer, 10035007);
        return bl;
    }

    private boolean cR(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.afv.b(byteBuffer, 10036004);
        return bl;
    }

    private boolean cS(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.afv.b(byteBuffer, 10037001);
        return bl;
    }

    private boolean cT(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.afv.b(byteBuffer, 10040005);
        return bl;
    }

    private boolean cU(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.afv.b(byteBuffer, 10045010);
        return bl;
    }

    private boolean cC(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.afv.b(byteBuffer, 10048000);
        return bl;
    }

    private boolean cV(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.afv.b(byteBuffer, 10055001);
        return bl;
    }

    private boolean cW(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.afv.b(byteBuffer, 10064001);
        return bl;
    }

    private boolean cX(ByteBuffer byteBuffer) {
        this.adx = byteBuffer.getShort();
        boolean bl = this.afv.b(byteBuffer, 10066001);
        return bl;
    }
