...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fze2.setTexture(this.okR.uF("iconesMruDefault"));
        fze2.setWidth(27);
        fze2.setX(32);
        fze2.setY(3);
        fym_02.X(fze2);
        ...
        fze3.setTexture(this.okR.uF("iconesMruOver"));
        fze3.setWidth(27);
        fze3.setX(32);
        fze3.setY(3);
        fym_03.X(fze3);
        ...
        fze4.setTexture(this.okR.uF("iconesMruPressed"));
        fze4.setWidth(27);
        fze4.setX(32);
        fze4.setY(3);
        fym_04.X(fze4);
        ...
        fze5.setTexture(this.okR.uF("iconesMruDisabled"));
        fze5.setWidth(27);
        fze5.setX(32);
        fze5.setY(3);
        fym_05.X(fze5);
