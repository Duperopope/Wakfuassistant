...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fym_02);
        fym_02.guy();
        String string = "pmbDefaultChatChannelBackgroundCut";
        ...
        fze2.setTexture(this.okR.uF("txChatChannelBackground"));
        fze2.setWidth(32);
        fze2.setX(0);
        fze2.setY(120);
        fkd_12.X(fze2);
        ...
        fes_22.X(fym_03);
        fym_03.guy();
        String string2 = "pmbHoverChatChannelBackgroundCut";
        ...
        fze3.setTexture(this.okR.uF("txChatChannelBackground"));
        fze3.setWidth(32);
        fze3.setX(201);
        fze3.setY(120);
        fkd_13.X(fze3);
        ...
        fes_22.X(fym_04);
        fym_04.guy();
        String string3 = "pmbPressedChatChannelBackgroundCut";
        ...
        fze4.setTexture(this.okR.uF("txChatChannelBackground"));
        fze4.setWidth(32);
        fze4.setX(402);
        fze4.setY(120);
        fkd_14.X(fze4);
        ...
        fes_22.X(fym_05);
        fym_05.guy();
        String string4 = "pmbDefaultChatChannelBackgroundCut";
        ...
        fze5.setTexture(this.okR.uF("txChatChannelBackground"));
        fze5.setWidth(32);
        fze5.setX(0);
        fze5.setY(120);
        fkd_15.X(fze5);
