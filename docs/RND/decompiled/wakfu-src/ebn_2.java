...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fze2.setTexture(this.okR.uF("txVelocityBar"));
        fze2.setWidth(3);
        fze2.setX(0);
        fze2.setY(0);
        fzg2.X(fze2);
        ...
        fze3.setTexture(this.okR.uF("txVelocityBar"));
        fze3.setWidth(3);
        fze3.setX(0);
        fze3.setY(3);
        fzg2.X(fze3);
        ...
        fze4.setTexture(this.okR.uF("txVelocityBar"));
        fze4.setWidth(3);
        fze4.setX(0);
        fze4.setY(23);
        fzg2.X(fze4);
        ...
        fze5.setTexture(this.okR.uF("txVelocityBar"));
        fze5.setWidth(1);
        fze5.setX(3);
        fze5.setY(0);
        fzg2.X(fze5);
        ...
        fze6.setTexture(this.okR.uF("txVelocityBar"));
        fze6.setWidth(1);
        fze6.setX(3);
        fze6.setY(3);
        fzg2.X(fze6);
        ...
        fze7.setTexture(this.okR.uF("txVelocityBar"));
        fze7.setWidth(1);
        fze7.setX(3);
        fze7.setY(23);
        fzg2.X(fze7);
        ...
        fze8.setTexture(this.okR.uF("txVelocityBar"));
        fze8.setWidth(1);
        fze8.setX(6);
        fze8.setY(0);
        fzg2.X(fze8);
        ...
        fze9.setTexture(this.okR.uF("txVelocityBar"));
        fze9.setWidth(1);
        fze9.setX(6);
        fze9.setY(3);
        fzg2.X(fze9);
        ...
        fze10.setTexture(this.okR.uF("txVelocityBar"));
        fze10.setWidth(1);
        fze10.setX(6);
        fze10.setY(23);
        fzg2.X(fze10);
