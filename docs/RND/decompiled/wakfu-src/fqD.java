...
public abstract class fqD {
    ...
    private final ang_2 sUp;
    private final ang_2 sUq;
    private final int sUr;
    private final ang_2 sUs;
    private final short sUt;
    private final fqN sUu;
    private final Map<ang_2, fqN> sUv;
    private final azl_2<enk_0> sUw = new azl_2();
    ...
    protected fqD(fqR fqR2) {
        ...
        this.sUt = fqR2.cvo();
        this.sUu = new fqN();
        Map<exx_2, fqG> map = fqR2.gjs();
        if (map != null) {
            for (Map.Entry<exx_2, fqG> entry : map.entrySet()) {
                this.sUu.a(entry.getKey(), entry.getValue().giT(), entry.getValue().cwh());
            }
        }
        this.sUv = fqR2.gjr();
        ...
        this.sUu.fh(fqR2.eeR());
        this.sUu.fi(fqR2.gjl());
    ...
    public Iterator<enk_0> fA(short s) {
    ...
    public fqO g(fqE fqE2, exP exP2, Object object, Object object2) {
        fqN fqN2 = this.a(exP2, object, fqE2, object2);
        eyu_0 eyu_02 = exP2.fhl();
        fqO fqO2 = new fqO();
        Map<exx_2, fqG> map = fqN2.giX();
        Set<exx_2> set = map.keySet();
        short s = fqE2.cmL();
        for (exx_2 exx_22 : set) {
            fqG fqG2 = map.get(exx_22);
            int n = fqG2.Ph(s);
            int n2 = 0;
            if (this.qEr != null) {
                for (fqS fqS2 : this.qEr) {
                    n2 += eyu_02.a(exx_22, fqS2);
                }
            }
            if (exx_22 == exx_2.rHH) {
                fqO2.h(exx_22.aJr(), n + n2);
                continue;
            }
            fqO2.g(exx_22.aJr(), Math.max(0, n + n2));
        }
        return fqO2;
    }
    ...
    private fqN y(Object object, Object object2, Object object3, Object object4) {
        ...
        if (this.sUv != null && !this.sUv.isEmpty()) {
            Set<ang_2> set = this.sUv.keySet();
            for (ang_2 ang_22 : set) {
                if (!ang_22.b(object, object2, object3, object4)) continue;
                fqN2 = this.sUv.get(ang_22);
            }
        }
        return fqN2;
    }
