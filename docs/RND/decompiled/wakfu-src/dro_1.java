...
implements fhh_2 {
    ...
    public void a(fhs_2 fhs_22, fhq_2 fhq_22, fes_2 fes_22) {
        ...
        fes_22.X(fzs6);
        fzs6.guy();
        String string5 = "worldBarButtonSelectedPixmap";
        ...
        fes_22.X(fzs7);
        fzs7.guy();
        String string6 = "worldBarButtonSelectedPressedPixmap";
        ...
        fes_22.X(fzs8);
        fzs8.guy();
        String string7 = "worldBarButtonSelectedOverPixmap";
        ...
        fes_22.X(fzs9);
        fzs9.guy();
        String string8 = "worldBarButtonSelectedDisabledPixmap";
