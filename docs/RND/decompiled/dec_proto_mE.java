...
implements mH {
    ...
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return mD.Lz.ensureFieldAccessorsInitialized(mE.class, mG.class);
    }
    ...
    public mG amV() {
        return this == LZ ? new mG() : new mG().c(this);
    }

    protected mG bZ(GeneratedMessageV3.BuilderParent builderParent) {
