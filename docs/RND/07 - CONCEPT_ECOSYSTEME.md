...
1. Capture HDV en jeu via `docs/RND/poc-hdv/agent/launch_hdv_v2.bat`.
2. Sync base via `docs/RND/poc-hdv/sync_hdv_to_sqlite.ps1`.
3. Export lisible via `docs/RND/poc-hdv/export_hdv_readable.ps1 -ResolveItemNames`.
4. Focus ressources via `docs/RND/poc-hdv/top_buy_over_sell_resources.ps1`.
...
2. Scripts actifs dans `docs/RND/poc-hdv/`.
...
1. `docs/RND/poc-hdv/agent/launch_hdv_v2.bat`.
...
1. `docs/RND/poc-hdv/sync_hdv_to_sqlite.ps1`.
...
1. `docs/RND/poc-hdv/export_hdv_readable.ps1`.
