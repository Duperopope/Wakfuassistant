# ============================================
#  DOCUMENTATION POC - JOURNAL AUTOMATIQUE
#  H:\Code\Wakfuassistant\docs\RND\poc-extractioninventairehavresac\generate_journal.ps1
# ============================================

$pocDir = "H:\Code\Wakfuassistant\docs\RND\poc-extractioninventairehavresac"
$outputDir = "$pocDir\output"
$journalPath = "H:\Code\Wakfuassistant\docs\RND\7 - Journal_POC_chest_inventory.md"
...
$journal | Out-File $journalPath -Encoding UTF8
Write-Host "============================================" -ForegroundColor Cyan
Write-Host "  JOURNAL GENERE" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
Write-Host "  $journalPath" -ForegroundColor Green
Write-Host "  $($journal.Length) caracteres" -ForegroundColor White
Write-Host ""
Write-Host "  Prochaines etapes suggerees:" -ForegroundColor Yellow
Write-Host "  1. Explorer les messages HDV (Hotel des Ventes)" -ForegroundColor White
Write-Host "  2. Investiguer la quantite dans les depots" -ForegroundColor White
Write-Host "  3. Resoudre les Havre-Gemmes/Ambiances" -ForegroundColor White
Write-Host "  4. Porter le POC en Rust/Tauri" -ForegroundColor White
Write-Host "============================================" -ForegroundColor Cyan
