# ============================================
#  FIX JOURNAL HDV + CAPTURE ETENDUE
#  H:\Code\Wakfuassistant\docs\RND\poc-hdv\generate_journal_hdv.ps1
# ============================================

$journalPath = "H:\Code\Wakfuassistant\docs\RND\8 - Journal_POC_HDV.md"
...
Write-Host "  Journal HDV sauvegarde: $journalPath" -ForegroundColor Green
